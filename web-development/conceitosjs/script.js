...
// let busca = destacarTermo("Corinthians é o melhor time do mundo!", "Corinthians")
...
// console.log(`A área do circulo com o ${raio}: ${areaCirculo}`)
...
// console.log(hoje)
// console.log(new Date("2025-06-12T14:00"))
// console.log(new Date("04-06-2025"))
